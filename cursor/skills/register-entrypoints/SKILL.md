...
description: Register safe local endpoints in Bright with realistic requests and working auth configuration.
---
...
`runDiscovery` with the same local base URL and active Repeater.
